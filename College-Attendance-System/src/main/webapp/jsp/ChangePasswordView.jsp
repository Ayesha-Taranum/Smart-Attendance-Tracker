...
<div class="container"
	...
	<form style="width: 60%; margin-top: 25px"
		action="<%=CASView.CHANGE_PASSWORD_CTL%>" method="post">
		...
		<div class="form-group">
			<label for="inputAddress" style="color: #007bff;"><i
				class="fas fa-lock"></i> Old Password:</label> <input type="password"
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="inputEmail4" style="color: #007bff;"><i
					class="fas fa-unlock-alt"></i> New Password:</label> <input type="password"
		...
		<input type="submit" name="operation" class="btn btn-primary rounded "
			value="<%=ChangePasswordCtl.OP_SAVE%>"> <br>
		<br>
	</form>
</div>
<br>
