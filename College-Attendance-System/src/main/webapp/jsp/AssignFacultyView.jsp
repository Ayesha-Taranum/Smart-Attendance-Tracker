...
<div class="container"
	...
	<div style="margin-top: 18px">
		<h2 style="color: #007bff;">
			<i class="fas fa-chalkboard-teacher"></i>Add Assign Faculty
		</h2>
	</div>

	<jsp:useBean id="bean"
		class="in.co.college.att.mgt.bean.AssignFacultyBean" scope="request"></jsp:useBean>
	<b><font color="red"><%=ServletUtility.getErrorMessage(request)%></font></b>
	<b><font color="green"><%=ServletUtility.getSuccessMessage(request)%></font></b>
	<form style="width: 60%; margin-top: 25px"
		action="<%=CASView.ASSIGN_FACULTY_CTL%>" method="post">
		...
		<div class="form-group">
			<label for="inputAddress" style="color: #007bff;"><i
				class="fas fa-user"></i>Faculty Name:</label>
		...
		<div class="form-group">
			<label for="inputAddress" style="color: #007bff;"><i
				class="fas fa-calendar-alt"></i>Total Class:</label> <input type="text"
				class="form-control" name="noClass"
				placeholder="Enter Total Class..."
				value="<%=DataUtility.getStringData(bean.getTotalClass())%>">
		...
		<input type="submit" name="operation" class="btn btn-primary rounded"
			value="<%=AssignFacultyCtl.OP_SAVE%>"> or <input
			type="submit" name="operation" class="btn btn-primary rounded"
			value="<%=AssignFacultyCtl.OP_RESET%>"> <br>
		<br>
	</form>
</div>
<br>
