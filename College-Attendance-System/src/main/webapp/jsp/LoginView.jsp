...
<div class="container"
	style="border: ridge; margin-top: 20px; margin-left: 60px">
	...
	<form method="post" action="<%=CASView.LOGIN_CTL%>"
		class="was-validated" style="width: 50%">
		<%
		...
		<div class="form-group" style="margin-top: 24px; margin-left: 60px">
			<label for="uname">Login Id:</label> <input type="text"
		...
		<input type="submit" name="operation" class="btn btn-primary rounded "
			style="margin-top: 24px; margin-left: 60px"
			value="<%=LoginCtl.OP_SIGN_IN%>"> <br>
		<br>
