...
<div class="container"
	...
	<form style="width: 60%; margin-top: 25px"
		action="<%=CASView.COURSE_CTL%>" method="post">
		...
		<div class="form-group">
			<label for="inputAddress" style="color: #007bff;"> <i
				class="fas fa-info-circle"></i>Description:
			</label>
...
<input type="submit" name="operation" class="btn btn-primary rounded"
					value="<%=CourseCtl.OP_SAVE%>"> or <input type="submit" name="operation" class="btn btn-primary rounded"
